...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Search <small>Blood/Donor</small></h1>

        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="index.php">Home</a>
            </li>
            <li class="breadcrumb-item active">Search Blood/Donor</li>
        </ol>
...
$sql1="SELECT * from tblbloodstock where Blood_Group=:bloodgroup";
$query1 = $dbh -> prepare($sql1);
$query1->bindParam(':bloodgroup',$bloodgroup,PDO::PARAM_STR);
$query1->execute();
...
{ ?> 
    ...
    <table border="6" cellspacing="15px" cellpadding="15px" width="780" style="background-color: rgb(127,179,213);">
        <tr><th>Blood Group</th>
            <th>Stock</th></tr>
        <tr><td><?php echo htmlentities($result1->Blood_Group);?></td>
            <td><?php echo htmlentities($result1->Stock);?></td>
        </tr>
    </table>
...
{
echo htmlentities("No Stock Found");
