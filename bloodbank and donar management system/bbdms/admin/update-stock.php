...
$stock=$_POST['stock'];	
$sql="update tblbloodstock set Stock=:stock where Blood_Group=:blood_group";
...
<head>
	...
	<title>BBDMS | Admin Update Blood Stock</title>
			...
			<div class="container-fluid">
				...
				<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<input type="text" class="form-control" name="blood_group" id="blood_group" value="" required>
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-4 control-label">Available Stock:</label>
												<div class="col-sm-8">
